...
namespace tecplot
{
	namespace ___3933
	{
		typedef std::map<uint16_t, std::string> ___3942;
		typedef std::map<uint16_t, uint64_t> ___3945;
		typedef std::map<std::string, std::string> TagDescriptionToDescriptionMap;
		std::string getFileNameSansFolder(std::string const &___1394);
	}
}
...
#define DATASET_HEADER_TAG_MAP_INITIALIZER boost::assign::map_list_of<uint16_t, uint64_t>(DATA_SET_TITLE_TAG, 0)(___2849, 0)(___2845, 0)(SUBZONE_MAX_I_SIZE_TAG, 0)(SUBZONE_MAX_J_SIZE_TAG, 0)(SUBZONE_MAX_K_SIZE_TAG, 0)(SUBZONE_MAX_FE_SIZE_TAG, 0)(___241, 0)(___1581, 0)(___795, 0)(___4083, 0)(___4651, 0)(ZONE_TYPE_FILE_LOC_TAG, 0)(___4630, 0)(___4610, 0)(___4676, 0)(___4686, 0)(___4670, 0)(ZONE_IMAX_OR_NUM_NODES_FILE_LOC_TAG, 0)(ZONE_JMAX_OR_NUM_CELLS_FILE_LOC_TAG, 0)(ZONE_KMAX_OR_NUM_CORNERS_FILE_LOC_TAG, 0)(___4674, 0)(___4365, 0)(VAR_ZONE_MIN_MAX_FILE_LOC_TAG, 0)(___4393, 0)(___4384, 0)(___4387, 0)(___4390, 0)
#define DATSET_HEADER_TAG_DESCRIPTIONS_MAP_INITIALIZER boost::assign::map_list_of<uint16_t, std::string>(DATA_SET_TITLE_TAG, DATA_SET_TITLE_DESCRIPTION)(___2849, NUM_ZONES_DESCRIPTION)(___2845, NUM_VARS_DESCRIPTION)(SUBZONE_MAX_I_SIZE_TAG, SUBZONE_MAX_I_SIZE_DESCRIPTION)(SUBZONE_MAX_J_SIZE_TAG, SUBZONE_MAX_J_SIZE_DESCRIPTION)(SUBZONE_MAX_K_SIZE_TAG, SUBZONE_MAX_K_SIZE_DESCRIPTION)(SUBZONE_MAX_FE_SIZE_TAG, SUBZONE_MAX_FE_SIZE_DESCRIPTION)(___241, AUX_DATA_FILE_LOC_DESCRIPTION)(___1581, GEOMETRY_FILE_LOC_DESCRIPTION)(___795, CUSTOM_LABELS_FILE_LOC_DESCRIPTION)(___4083, TEXT_FILE_LOC_DESCRIPTION)(NUM_PARTITION_FILES_TAG, NUM_PARTITION_FILES_DESCRIPTION)(___4651, ZONE_NAME_FILE_LOC_DESCRIPTION)(ZONE_TYPE_FILE_LOC_TAG, ZONE_TYPE_FILE_LOC_DESCRIPTION)(___4630, ZONE_HEADER_FILE_LOC_DESCRIPTION)(___4610, ZONE_FACE_NEIGHBOR_MODE_FILE_LOC_DESCRIPTION)(___4676, ZONE_SOLUTION_TIME_FILE_LOC_DESCRIPTION)(___4686, ZONE_STRAND_ID_FILE_LOC_DESCRIPTION)(___4670, ZONE_PARENT_ZONE_FILE_LOC_DESCRIPTION)(ZONE_IMAX_OR_NUM_NODES_FILE_LOC_TAG, ZONE_IMAX_OR_NUM_NODES_FILE_LOC_DESCRIPTION)(ZONE_JMAX_OR_NUM_CELLS_FILE_LOC_TAG, ZONE_JMAX_OR_NUM_CELLS_FILE_LOC_DESCRIPTION)(ZONE_KMAX_OR_NUM_CORNERS_FILE_LOC_TAG, ZONE_KMAX_OR_NUM_CORNERS_FILE_LOC_DESCRIPTION)(___4674, ZONE_SHARE_CONNECTIVITY_FILE_LOC_DESCRIPTION)(___4365, VAR_NAME_FILE_LOC_DESCRIPTION)(VAR_ZONE_MIN_MAX_FILE_LOC_TAG, VAR_ZONE_MIN_MAX_FILE_LOC_DESCRIPTION)(___4393, VAR_ZONE_VALUE_LOCATION_FILE_LOC_DESCRIPTION)(___4384, VAR_ZONE_FIELD_DATA_TYPE_FILE_LOC_DESCRIPTION)(___4387, VAR_ZONE_IS_PASSIVE_FILE_LOC_DESCRIPTION)(___4390, VAR_ZONE_SHARE_FILE_LOC_DESCRIPTION)
...
#define ___4689 boost::assign::map_list_of<uint16_t, std::string>((uint16_t)___2784, NUM_CELL_SUBZONES_DESCRIPTION)((uint16_t)___2824, NUM_NODE_SUBZONES_DESCRIPTION)((uint16_t)CSZ_CONNECT_FILE_LOC_TAG, CSZ_CONNECT_FILE_LOC_DESCRIPTION)((uint16_t)NSZ_CONNECT_FILE_LOC_TAG, NSZ_CONNECT_FILE_LOC_DESCRIPTION)((uint16_t)UNUSED1_ZONE_TAG, ZONE_UNUSED1_TAG_DESCRIPTION)((uint16_t)NUM_REF_PARTITIONS_TAG, NUM_REF_PARTITIONS_DESCRIPTION)((uint16_t)REF_PARTITIONS_TAG, REF_PARTITIONS_DESCRIPTION)((uint16_t)NUM_REF_NODE_SUBZONES_TAG, NUM_REF_NODE_SUBZONES_DESCRIPTION)((uint16_t)NUM_REF_CELL_SUBZONES_TAG, NUM_REF_CELL_SUBZONES_DESCRIPTION)((uint16_t)CELL_SUBZONE_INCLUDES_PARTITIONS_TAG, CELL_SUBZONE_INCLUDES_PARTITIONS_DESCRIPTION)((uint16_t)NODE_SUBZONE_INCLUDES_PARTITIONS_TAG, NODE_SUBZONE_INCLUDES_PARTITIONS_DESCRIPTION)((uint16_t)___4342, VAR_FILE_LOC_DESCRIPTION)((uint16_t)___2725, NODE_MAP_FILE_LOC_DESCRIPTION)((uint16_t)USER_FACE_NBR_FILE_LOC_TAG, USER_FACE_NBR_FILE_LOC_DESCRIPTION)((uint16_t)NUM_PARTITIONS_TAG, NUM_PARTITIONS_DESCRIPTION)((uint16_t)PARTITION_FILE_NUM_TAG, PARTITION_FILE_NUM_DESCRIPTION)((uint16_t)PARTITION_FILE_LOC_TAG, PARTITION_FILE_LOC_DESCRIPTION)((uint16_t)PARTITION_NUM_CELLS_TAG, PARTITION_NUM_CELLS_DESCRIPTION)((uint16_t)PARTITION_NUM_NODES_TAG, PARTITION_NUM_NODES_DESCRIPTION)((uint16_t)VAR_PARTITION_MIN_MAX_TAG, VAR_PARTITION_MIN_MAX_DESCRIPTION)((uint16_t)PARTITION_MIN_NODE_NUMBERS_TAG, PARTITION_MIN_NODE_NUMBERS_DESCRIPTION)((uint16_t)PARTITION_MAX_NODE_NUMBERS_TAG, PARTITION_MAX_NODE_NUMBERS_DESCRIPTION)
#define PARTITION_TAG_DESCRIPTIONS_MAP_INITIALIZER boost::assign::map_list_of<uint16_t, std::string>((uint16_t)CSZ_CONNECT_FILE_LOC_TAG, CSZ_CONNECT_FILE_LOC_DESCRIPTION)((uint16_t)NSZ_CONNECT_FILE_LOC_TAG, NSZ_CONNECT_FILE_LOC_DESCRIPTION)((uint16_t)NUM_REF_PARTITIONS_TAG, NUM_REF_PARTITIONS_DESCRIPTION)((uint16_t)REF_PARTITIONS_TAG, REF_PARTITIONS_DESCRIPTION)((uint16_t)NUM_REF_NODE_SUBZONES_TAG, NUM_REF_NODE_SUBZONES_DESCRIPTION)((uint16_t)NUM_REF_CELL_SUBZONES_TAG, NUM_REF_CELL_SUBZONES_DESCRIPTION)((uint16_t)CELL_SUBZONE_INCLUDES_PARTITIONS_TAG, CELL_SUBZONE_INCLUDES_PARTITIONS_DESCRIPTION)((uint16_t)NODE_SUBZONE_INCLUDES_PARTITIONS_TAG, NODE_SUBZONE_INCLUDES_PARTITIONS_DESCRIPTION)((uint16_t)___4342, VAR_FILE_LOC_DESCRIPTION)((uint16_t)___2784, NUM_CELL_SUBZONES_DESCRIPTION)((uint16_t)___2824, NUM_NODE_SUBZONES_DESCRIPTION)
...
#define ALT_TAG_DESCRIPTIONS_MAP_INITIALIZER boost::assign::map_list_of<std::string, std::string>(NSZ_CONNECT_FILE_LOC_DESCRIPTION, "nszConnectivityFileLocs")(CSZ_CONNECT_FILE_LOC_DESCRIPTION, "cszConnectivityFileLocs")(NSZ_CONNECT_FILE_LOC_ARRAY_DESCRIPTION, "nszConnectivityFileLocsForZone")(CSZ_CONNECT_FILE_LOC_ARRAY_DESCRIPTION, "cszConnectivityFileLocsForZone")(VAR_ZONE_IS_PASSIVE_FILE_LOC_DESCRIPTION, "passive")(VAR_ZONE_SHARE_FILE_LOC_DESCRIPTION, "share")
