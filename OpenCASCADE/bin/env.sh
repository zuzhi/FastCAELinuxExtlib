...
if [ "${CASROOT}" == "" ]; then
  export CASROOT="/home/chan/temp/FastCAELinuxExtlibSource/opencascade-7.6.0/install"
fi

# ----- Define path to 3rdparty products -----
if [ "${THIRDPARTY_DIR}" == "" ]; then
  export THIRDPARTY_DIR="/home/chan/temp/FastCAELinuxExtlibSource/opencascade-7.6.0"
fi
