...
set_target_properties(TKGeomAlgo PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKGeomAlgo.so.7.6.0"
  IMPORTED_SONAME_RELEASE "libTKGeomAlgo.so.7"
  )

list(APPEND _IMPORT_CHECK_TARGETS TKGeomAlgo )
list(APPEND _IMPORT_CHECK_FILES_FOR_TKGeomAlgo "${_IMPORT_PREFIX}/lib/libTKGeomAlgo.so.7.6.0" )
...
set_target_properties(TKTopAlgo PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKTopAlgo.so.7.6.0"
  IMPORTED_SONAME_RELEASE "libTKTopAlgo.so.7"
  )

list(APPEND _IMPORT_CHECK_TARGETS TKTopAlgo )
list(APPEND _IMPORT_CHECK_FILES_FOR_TKTopAlgo "${_IMPORT_PREFIX}/lib/libTKTopAlgo.so.7.6.0" )
...
set_target_properties(TKPrim PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKPrim.so.7.6.0"
  IMPORTED_SONAME_RELEASE "libTKPrim.so.7"
  )

list(APPEND _IMPORT_CHECK_TARGETS TKPrim )
list(APPEND _IMPORT_CHECK_FILES_FOR_TKPrim "${_IMPORT_PREFIX}/lib/libTKPrim.so.7.6.0" )
...
set_target_properties(TKBO PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKBO.so.7.6.0"
  IMPORTED_SONAME_RELEASE "libTKBO.so.7"
  )

list(APPEND _IMPORT_CHECK_TARGETS TKBO )
list(APPEND _IMPORT_CHECK_FILES_FOR_TKBO "${_IMPORT_PREFIX}/lib/libTKBO.so.7.6.0" )
...
set_target_properties(TKShHealing PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKShHealing.so.7.6.0"
  IMPORTED_SONAME_RELEASE "libTKShHealing.so.7"
  )

list(APPEND _IMPORT_CHECK_TARGETS TKShHealing )
list(APPEND _IMPORT_CHECK_FILES_FOR_TKShHealing "${_IMPORT_PREFIX}/lib/libTKShHealing.so.7.6.0" )
...
set_target_properties(TKBool PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKBool.so.7.6.0"
  IMPORTED_SONAME_RELEASE "libTKBool.so.7"
  )

list(APPEND _IMPORT_CHECK_TARGETS TKBool )
list(APPEND _IMPORT_CHECK_FILES_FOR_TKBool "${_IMPORT_PREFIX}/lib/libTKBool.so.7.6.0" )
...
set_target_properties(TKHLR PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKHLR.so.7.6.0"
  IMPORTED_SONAME_RELEASE "libTKHLR.so.7"
  )

list(APPEND _IMPORT_CHECK_TARGETS TKHLR )
list(APPEND _IMPORT_CHECK_FILES_FOR_TKHLR "${_IMPORT_PREFIX}/lib/libTKHLR.so.7.6.0" )
...
set_target_properties(TKFillet PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKFillet.so.7.6.0"
  IMPORTED_SONAME_RELEASE "libTKFillet.so.7"
  )

list(APPEND _IMPORT_CHECK_TARGETS TKFillet )
list(APPEND _IMPORT_CHECK_FILES_FOR_TKFillet "${_IMPORT_PREFIX}/lib/libTKFillet.so.7.6.0" )
...
set_target_properties(TKOffset PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKOffset.so.7.6.0"
  IMPORTED_SONAME_RELEASE "libTKOffset.so.7"
  )

list(APPEND _IMPORT_CHECK_TARGETS TKOffset )
list(APPEND _IMPORT_CHECK_FILES_FOR_TKOffset "${_IMPORT_PREFIX}/lib/libTKOffset.so.7.6.0" )
...
set_target_properties(TKFeat PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKFeat.so.7.6.0"
  IMPORTED_SONAME_RELEASE "libTKFeat.so.7"
  )

list(APPEND _IMPORT_CHECK_TARGETS TKFeat )
list(APPEND _IMPORT_CHECK_FILES_FOR_TKFeat "${_IMPORT_PREFIX}/lib/libTKFeat.so.7.6.0" )
...
set_target_properties(TKMesh PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKMesh.so.7.6.0"
  IMPORTED_SONAME_RELEASE "libTKMesh.so.7"
  )

list(APPEND _IMPORT_CHECK_TARGETS TKMesh )
list(APPEND _IMPORT_CHECK_FILES_FOR_TKMesh "${_IMPORT_PREFIX}/lib/libTKMesh.so.7.6.0" )
...
set_target_properties(TKXMesh PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKXMesh.so.7.6.0"
  IMPORTED_SONAME_RELEASE "libTKXMesh.so.7"
  )

list(APPEND _IMPORT_CHECK_TARGETS TKXMesh )
list(APPEND _IMPORT_CHECK_FILES_FOR_TKXMesh "${_IMPORT_PREFIX}/lib/libTKXMesh.so.7.6.0" )
